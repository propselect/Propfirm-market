    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 bg-zinc-950 py-12">
      ...
      >
        ...
        <div className="mb-10 text-center">
          <h1 className="text-5xl font-black text-white mb-4 tracking-tighter italic uppercase leading-none">Welcome<br />Back.</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-zinc-900 px-4 text-zinc-600 font-bold tracking-tighter uppercase italic text-[9px]">Or Terminal Entry</span>
            </div>
          </div>
